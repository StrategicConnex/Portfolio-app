...
export class AskAIErrorBoundary extends React.Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="fixed bottom-6 right-6 z-50 w-[380px] sm:w-[420px] bg-slate-950/95 backdrop-blur-xl border border-red-800/50 shadow-2xl rounded-2xl overflow-hidden">
